...
**Never hand-edit these files** — they are auto-generated and any manual changes
will be overwritten the next time generation runs:

- `src/WebApp.Client/swagger.json` — generated by NSwag from the ASP.NET app
- `src/WebApp.Client/Services/Generated/**` — generated by Kiota from swagger.json
- `tests/Farkle.WebTests/Generated/**` — generated by Kiota from swagger.json
...
3. Regenerate the Kiota client:
   ```bash
   cd src/WebApp.Client/Services/Generated && kiota generate && cd -
   # For integration tests client:
   cd tests/Farkle.WebTests/Generated && kiota generate && cd -
   ```
