...
/// </remarks>
public sealed class FarkleApiConnection : IDisposable
{
    private readonly HttpClient               _http;
    private readonly HttpClientRequestAdapter _adapter;
    private          bool                     _disposed;

    public FarkleApiConnection(string baseUrl, HttpMessageHandler? handler = null)
    {
    ...
    public FarkleApiClient Client { get; }
