...
using KiotaFeedbackRequest = HotDice.ApiClient.Models.SubmitFeedbackRequest;
...
public sealed class FeedbackService(HotDiceApiClient client, IJSRuntime js, ILogger<FeedbackService> logger)
  : IFeedbackService
{
