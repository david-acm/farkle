...
using KiotaModels = HotDice.ApiClient.Models;
...
{
  private readonly HotDiceApiClient      _client;
  private readonly ILogger<GameService> _logger;

  public GameService(HotDiceApiClient client, ILogger<GameService> logger)
  {
    _client = client;
    _logger = logger;
  }
