...
namespace HotDice.Client.Tests.Api;

/// <summary>
/// Proves the mobile app's API path is unit-testable off-device: <see cref="HotDiceApiConnection"/>
...
public class MobileApiClientShould
{
    ...
    public async Task SendRequestsToTheConfiguredAbsoluteBaseAddress()
    {
        ...
        using var connection = new HotDiceApiConnection(BaseUrl, handler);
    ...
    public void RejectARelativeBaseAddress()
    {
        ...
        var create = () => new HotDiceApiConnection("/api", handler);
    ...
    public void NotDisposeAHandlerItDoesNotOwn()
    {
        ...
        using (var connection = new HotDiceApiConnection(BaseUrl, callerOwned))
        {
    ...
    public void DisposeCleanlyWhenItOwnsTheWholeChain()
    {
        ...
        var connection = new HotDiceApiConnection(BaseUrl);
