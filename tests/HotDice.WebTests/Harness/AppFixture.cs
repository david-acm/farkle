...
//
// External Wolverine transports are disabled (see HotDiceTestHost) so the endpoints' cascaded broadcast
...
public class AppFixture : IAsyncLifetime
{
  ...
  public async Task InitializeAsync()
  {
    ...
    Host = await HotDiceTestHost.StartAsync(ConnectionString, MartenSchema, ConfigureTestServices);
  }
