...
public class HandleShould : HandlerTestContext
{
  ...
  public async Task SendDerivedSetAsideDice_RemoveThemFromInPlay_AndUpdateTurnScore()
  {
    ...
    State.DiceInPlay.Add(TrayDie.Selected(0, DieValue.Five));
    State.DiceInPlay.Add(TrayDie.Unselected(1, DieValue.Three));
  ...
  {
    State.DiceInPlay.Add(TrayDie.Unselected(0, DieValue.Two));
